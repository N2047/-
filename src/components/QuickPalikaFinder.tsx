    ...
    <section aria-labelledby="quick-finder-heading" className="py-8 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-linear-to-r from-blue-950 via-indigo-950 to-slate-900 rounded-3xl p-6 sm:p-8 text-white shadow-2xl border border-blue-800/40 relative overflow-hidden">
          ...
          {/* Top Bar: Geography badge + Unified Authentication Status */}
              ...
              {isAuthenticated && user ? (
                <div className="inline-flex items-center gap-2 bg-emerald-950/80 border border-emerald-500/50 px-3 py-1.5 rounded-xl text-xs">
                  ...
                  <span className="text-emerald-300/80 text-[11px] hidden sm:inline">
                    ({isSuperAdmin ? "👑 Super Admin" : isEmployee ? `🏛️ ${assignedPalikaName}` : "👤 नागरिक"})
                  </span>
                  <button
                    type="button"
                    onClick={logout}
                ...
                <button
                  ...
                  className="px-3 py-1.5 bg-gradient-to-r from-blue-700 to-indigo-800 hover:from-blue-600 hover:to-indigo-700 text-white rounded-xl font-black text-xs flex items-center gap-1.5 transition-all cursor-pointer border border-blue-500/50 shadow-sm"
                >
