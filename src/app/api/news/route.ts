...
export async function POST(request: Request) {
  try {
    ...
    const newArticle = createNews({
      ...
      summary_en: summary_en ? summary_en.trim() : undefined,
      content_ne: content_ne.trim(),
      content_en: content_en ? content_en.trim() : undefined,
      published_date_bs: published_date_bs ? published_date_bs.trim() : "२०८२/०५/२१",
      published_date_en: published_date_en ? published_date_en.trim() : undefined,
